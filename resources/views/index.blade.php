                        ...
                        <div class="single-posts col-lg-4 col-sm-4 mb-3">
                            ...
                            <div class="detail">
                                ...
                                <ul class="d-flex space-around">
                                    ...
                                    {{--                                                class="fa fa-heart-o"--}}
                                    {{--                                                aria-hidden="true"></i><span> {{$post->likedUsers->count()}}</span></a>--}}
                                    {{--                                    </li>--}}
                                    <li><a href="javascript:void(0);"
                                           onclick=" toastr.info('To add to your favorite list you have to login first.', 'Info', { closeButton: true, progressBar: true, })"><i
                                                class="fa fa-heart-o" aria-hidden="true"></i><span></span></a></li>


                                    {{--                                    <li><i class="fa fa-comment-o"--}}
                                    {{--                                           aria-hidden="true"></i><span> {{$post->comments->count()}}</span></li>--}}
                                    {{--                                    <li><i class="fa fa-eye" aria-hidden="true"></i> <span>{{$post->view_count}}</span>--}}
                                    {{--                                    </li>--}}
        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-70 col-lg-8">
                    <div class="title text-center">
                        ...
                        <p>This is personal blogging site related to Internet of Things &amp; Web Development
                            Tutorials</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center d-flex align-items-center">
                <div class="col-lg-6 team-left">
                    ...
                    <p>
                        This site is made with laravel framework. The theme is <a href="">Blogger Theme</a> and the
                        Admin Panel theme is <a href="https://github.com/puikinsh/sufee-admin-dashboard">Sufee Admin</a>.
                    </p>
                    ...
                    <p>I am <span class="c1">Full stack Web Developer</span> specialized <span class="c1">LARAVEL</span>
                        - PHP. Currently Studing GEOSPATIAL SCIENCE and learning <span class="c1">GIS Web Applications Development</span>.
                    </p>
                    <br>
                    <h4>Email: <span style="font-size: medium; font-weight: lighter;">hiddendragon294@gmail.com</span>
                    </h4>
                    <br>
                    <div class="col-md-12 d-flex justify-content-center py-3 mt-2">
                        <a href="" class="genric-btn info circle arrow mr-md-auto" target="_blank">Know More<span
                                ...
                                @foreach($users as $item)
                                    @if($item->role_id == 1)
                                        <img class="img-fluid w-75 mx-auto"
                                             src="{{asset('storage/user/'.$item->image)}}" alt="admin">
